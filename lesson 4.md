...
# Представление преподавателя ([00:16:35](https://youtu.be/-xZ02dEF6kU?t=995))
- Сергей Бондарев
...
# Volumes ([01:01:05](https://youtu.be/-xZ02dEF6kU?t=3665))
...
## Экспериментируем ([01:02:36](https://youtu.be/-xZ02dEF6kU?t=3756))
...
# Downward API ([01:20:57](https://youtu.be/-xZ02dEF6kU?t=4857))
- Документация:
...
- Некоторые значения берутся из манифеста, некоторые подставляет kubernetes, например, те что в секции status. Об каждом имеет смысл читать отдельно в документации
...
- Далее Сергей сверяет полеченные данные с теми, что можно увидеть по команде `kubectl get pod -o wide`, данная команда даёт расширенную информацию, в том числе IP адрес пода, имя ноды

# Остановился [здесь](https://youtu.be/-xZ02dEF6kU?t=5626)