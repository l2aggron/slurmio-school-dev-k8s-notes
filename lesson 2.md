...
- Является одним инстансом запущенного приложения
- Если kubernetes воспринимать не только как систему оркестрации контейнеров, а как кластерную ОС, то pod можно воспринимать как процесс
- Является минимальной абстракцией kubernetes (как привило, внутри него 2 контейнера, иногда больше)
...
- "---" в yaml - обозначение начала документа (абстракции) в рамках файла
