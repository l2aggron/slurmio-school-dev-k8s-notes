...
- |
    ...
    - A: 
        - Ответ можно найти, [интернете](https://stackoverflow.com/questions/47369351/kubectl-apply-vs-kubectl-create), а также в [третьей](lesson%203.md#Разница-между-create-и-apply) и [шестой](lesson%206.md#Разбираем-сервис-ClusterIP) лекциях
